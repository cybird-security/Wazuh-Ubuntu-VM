# Configuring an Ubuntu Server Virtual Machine Running Wazuh

The goal is to configure an Ubuntu Server virtual machine running Wazuh, an open-source SIEM (Security Information and Event Management) application.
